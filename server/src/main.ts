...
// variables
let formsData: formsDataType[] = JSON.parse(fs.readFileSync(path.join(__dirname, '../data/db.json')).toString());

function databaseUpdate(formData: { firstName: string, lastName: string, email: string, labels: object | string }) {
...
function databaseSearch(formData: { firstName: string, lastName: string, email: string }) {
...
function jsonUpdate(formData: formsDataType) {
